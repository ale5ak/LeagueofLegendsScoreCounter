...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttons[0] = (Button) findViewById(R.id.add3forA);
        buttons[1] = (Button) findViewById(R.id.add2forA);
        buttons[2] = (Button) findViewById(R.id.add1forA);
        buttons[3] = (Button) findViewById(R.id.add3forB);
        buttons[4] = (Button) findViewById(R.id.add2forB);
        buttons[5] = (Button) findViewById(R.id.add1forB);
